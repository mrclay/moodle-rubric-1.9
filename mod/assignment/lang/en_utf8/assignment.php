...
$string['uploadresponsefile'] = 'Upload Response file';
...
$string['typewebpage'] = 'Webpage Url';
$string['helpwebpage'] = '<p>This type of assignment allows each participant to submit the url of a 
   webpage they have completed.</p> <p>This would allow anyone as a Teacher of Teaching Assistant role
   to view the sutudent\'s submitted webpage while it remains on their respective server.</p>';
$string['urlwebpage'] = 'Student\'s webpage address';
$string['urlwebpagestudent'] = 'Webpage address';
$string['userkeywords'] = 'Student keywords';
$string['userkeywordsval'] = '<font color=\"#808080\">Username: <strong>&#37;user</strong>, &lt;First Name&gt;_&lt;Last Name&gt;: <strong>&#37;name</strong></font>';
$string['definewebsiteurl'] = 'Define address';
$string['checklink'] = 'Open Address Link';
...
$string['norubrics'] = 'No rubrics where found for this course';
...
$string['nodelete'] = 'Dissassociate or remove all assignments associated with this rubric first.';
...
$string['loadfromfile'] = 'Import';
$string['selectfile'] = 'Select a file to Import';
